...
const Footer = () => {
    return (
            <div>
            <div className='footer-top'style={{backgroundImage: `url(${footerbg})`, backgroundRepeat: "no-repeat", backgroundSize:"cover",position:"relative",backgroundPosition:"center",zIndex:'5',color:'white',padding:"70px 0"
             }}>
